...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\response{ 
			We thank the referee for the comment. We have included a brief introductory paragraph in the revised manuscript to provide a general understanding of the DTC in DMBL in page 3 para 2. In the same para we have discussed how DTC is defined and talked about the fundamental properties of DTC.
