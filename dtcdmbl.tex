...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			In order to stabilize a DTC in the system, previous studies included localization in the many-body system. In the proposed model we incorporate the localization by the dynamics of the system itself. In the earlier work we observed that DMBL is stable at higher frequencies~\cite{Mahbub2024}. Additionally, in this frequency limit we can apply Rotating Wave Approximation (RWA) which is a quantum mechanical tool for simplifying the analysis of systems with high-frequency driving fields. Thus, we have chosen $\omega=20$ for the numerical simulations. We have discussed this in the revised manuscript at section 3, page 7, last para.\\

			We have explained how the time evolution of local magnetization and its FFT analysis contributes to defining DTC. We have included this discussion in the revised manuscript at page 3.
			}
