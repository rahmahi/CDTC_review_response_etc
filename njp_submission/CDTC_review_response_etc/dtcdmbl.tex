...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\response{ 
			We appreciate the referee's comment. We have added a concise introductory paragraph in the revised manuscript on page 3 para 2, which provides a general understanding of the DTC in DMBL systems. We also discuss the definition of DTC and its fundamental properties.\\
